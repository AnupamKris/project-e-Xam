...
<img src='/static/logo.jpg' height="200px" class='center' style="margin-left: 37.5%;width :25%;height: 150px;margin-top:auto;border-radius: 20%;">
...
<div  class='content' style="background-color:#141414;padding:20px;width:screen.width px;height:90px;margin-right: auto;margin-left:auto;display: block;margin-top: 90px">
  ...
  % y = questions[i]
  <div id='myDIV'>
  <textarea id='questionbox' disabled>{{ str(i)+') ' + y['Q'] }}</textarea><br>
  ...
  <input id="radbut" type="radio" name="question{{ i }}" value="{{ A }}">
